...
print("${{goto 60}}${{voffset -150}}${{font Comfortaa:size=20}}{}{}${{goto 160}}{}{}${{goto 260}}{}{}${{goto 360}}{}{}${{goto 460}}{}{}".format(current,symbol,forecast1,symbol,forecast2,symbol,forecast3,symbol,forecast4,symbol))
print("${{goto 32}}${{voffset -10}}${{font Comfortaa:size=12}}{}${{goto 132}}{}${{goto 232}}{}${{goto 332}}{}${{goto 432}}{}${{font}}".format(result[0],result[1],result[2],result[3],result[4]))
